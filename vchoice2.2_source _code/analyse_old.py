...
class StyleBoxfileModel(Model):
    ...
    def visual_pie(data,path):
        ...
        sizes = [data[style]['prop'] for style in labels[:-1]]
...
if __name__ == '__main__':
    options = {'time': [2015, None, None],'visual_option': ['histogram'],  'sort_by': ['boxfile']}
    new = StyleBoxfileModel(1, '2018_12_18', options)
    print(new.process())